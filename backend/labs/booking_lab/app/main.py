...
class Settings:
    ...
    MISSION_ID: str = os.getenv("MISSION_ID", "booking-lab")
...
async def lifespan(app: FastAPI):
    print("Booking Lab starting (13 active flags)")
    yield
    print("Booking Lab shutdown")

app = FastAPI(title="Booking Lab", version="1.0.0", lifespan=lifespan)
